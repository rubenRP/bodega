<template>
  <div>
    ...
    <div
      id="sidebar"
      class="flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:!w-64 shrink-0 bg-gradient-to-l from-pink-900 to-pink-800 p-4 transition-all duration-200 ease-in-out"
      :class="showSidebar ? 'translate-x-0' : '-translate-x-64 '"
    >
      <div class="flex justify justify-between mb-10 pr-3 sm:px-2">
        <button
          class="lg:hidden text-slate-100 hover:text-slate-400"
        ...
        ><NuxtLink aria-current="page" class="block active" to="/">
          <Logo class="w-36 lg:w-32 text-white" :hiddenTitle="true" />
        </NuxtLink>
      </div>
      <div class="space-y-8">
        <div>
